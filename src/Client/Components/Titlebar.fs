        ...
        React.functionComponent
            ("titlebar",
             (fun (props: Props) ->
                 ...
                 let buttonsLeft =
                     props.ButtonsLeft |> List.map (fun b -> createButton classes.menuButton b.Dispatch b.Button)

                 let buttonsRight =
                     props.ButtonsRight |> List.map (fun b -> createButton classes.menuButton b.Dispatch b.Button)
